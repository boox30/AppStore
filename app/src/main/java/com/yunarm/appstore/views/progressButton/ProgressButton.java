package com.yunarm.appstore.views.progressButton;
...
public class ProgressButton extends AppCompatButton {
    ...
    private GradientDrawable mDrawableProgressDone;
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        //progress finish the background drawable
        ...
        mDrawableProgressDone.setCornerRadius(mCornerRadius);
